...
namespace DelegatesDemo
{
    ...
    public class Program
    {
        public static void Main()
        {
            ...
            calcBtn.Clicked += prg.CalculatorBtnClicked; calcBtn.SimulateClick();
        ...
        {
            Console.WriteLine($"Caller is a CalculatorButton: {sender is CalculatorButton} and is named {e.Name}");
        }
    }
}